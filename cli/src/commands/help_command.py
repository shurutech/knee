import typer
from constants import SUBCOMMAND_TO_DESCRIPTION_MAP, COMMANDS_TO_DESCRIPTION_MAP
...
def command_callback(value: bool):
    if value:
        for category, data in SUBCOMMAND_TO_DESCRIPTION_MAP.items():
...
def help_callback(value: bool):
    if value:
        ...
        for command, description in COMMANDS_TO_DESCRIPTION_MAP.items():
