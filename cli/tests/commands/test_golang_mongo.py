...
class TestGolangMongo(unittest.TestCase):
    ...
    @patch("src.commands.golang_mongo.FileManager.write_to_file")
    @patch("src.commands.golang_mongo.inquirer.confirm")
    def test_write_configuration_and_run_playbook_when_it_is_called(
        self, mock_confirm, mock_write_to_file
    ):
        mock_confirm.return_value.execute.return_value = False
        golang_mongo = GolangMongo()
    ...
    @patch("src.commands.golang_mongo.inquirer.confirm")
    @patch("src.commands.golang_mongo.FileManager.write_to_file")
    def test_number_of_times_write_to_file_called(
        self, mock_write_config, mock_confirm
    ):
        mock_confirm.return_value.execute.return_value = False
        golang_mongo = GolangMongo()
        golang_mongo.database = MagicMock()
    ...
    @patch("src.commands.golang_mongo.inquirer.confirm")
    @patch("src.commands.golang_mongo.load_configuration")
    ...
    def test_check_configs(
        self,
        mock_golang_parameter_configuration,
        mock_mongodb_parameter_configuration,
    ...
    def test_check_defaults_with_configuration_when_acceptance_is_true(
        self,
        mock_write_configuration_and_run_playbook,
        mock_check_hosts,
        mock_check_configs,
        mock_confirm,
    ):
    ...
    @patch("src.commands.golang_mongo.GolangMongo.check_hosts")
    @patch("src.commands.golang_mongo.GolangMongo.write_configuration_and_run_playbook")
    def test_check_defaults_with_configuration_when_acceptance_is_false(
        self,
        mock_write_configuration_and_run_playbook,
        mock_check_hosts,
        mock_check_configs,
