...
class TestMongodb(unittest.TestCase):
    def test_update_configuration_with_default_values(self):
        mongodb = Mongodb()
        mongodb.configs = {"mongodb_server.yml": {"mongodb_port": "27017"}}
    ...
    def test_update_configuration_with_user_input(self):
        ...
        with patch("builtins.input", return_value="27018"):
            mongodb.configs = load_configuration(mongodb.configs)
        self.assertEqual(
            mongodb.configs["mongodb_server.yml"]["mongodb_port"], "27018"
        )
    ...
    def test_update_configuration_when_is_replica_required_true(self):
        ...
        mongodb.configs = {
            ...
            "mongodb_replica_server.yml": {"mongodb_port": "27017"},
        }
        ...
        self.assertEqual(
            mongodb.configs["mongodb_replica_server.yml"]["mongodb_port"], "27019"
        )
    ...
    def test_apply_configuration_called_with_expected_arguments(
        ...
        mongodb.config_files = ["mongodb_server.yml"]
        mongodb.configs = {
            "mongodb_server.yml": {
        ...
        expected_call = call(
            ...
            "mongodb_server.yml",
            mongodb.configs["mongodb_server.yml"],
        )
